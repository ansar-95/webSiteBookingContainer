...
use App\Http\Model\Migrations;
use App\Http\Model\MigrationsQuery;
...
class MigrationsTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\App\\Http\\Model\\Migrations';
    ...
    protected $normalizedColumnNameMap = [
        ...
        'migration' => 'MIGRATION',
        'migrations.migration' => 'MIGRATION',
        'MigrationsTableMap::COL_MIGRATION' => 'MIGRATION',
        ...
        'batch' => 'BATCH',
        'migrations.batch' => 'BATCH',
        'MigrationsTableMap::COL_BATCH' => 'BATCH',
        'COL_BATCH' => 'BATCH',
        'batch' => 'BATCH',
        'migrations.batch' => 'BATCH',
    ];
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\Http\\Model\\Migrations');
        $this->setPackage('');
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(MigrationsTableMap::COL_ID);
            $criteria->removeSelectColumn(MigrationsTableMap::COL_MIGRATION);
            $criteria->removeSelectColumn(MigrationsTableMap::COL_BATCH);
        } else {
            $criteria->removeSelectColumn($alias . '.id');
            $criteria->removeSelectColumn($alias . '.migration');
            $criteria->removeSelectColumn($alias . '.batch');
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Http\Model\Migrations) { // it's a model object
