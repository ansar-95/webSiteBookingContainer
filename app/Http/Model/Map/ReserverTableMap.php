...
class ReserverTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addForeignPrimaryKey('codeReservation', 'Codereservation', 'INTEGER' , 'reservation', 'codeReservation', true, 10, null);
  ...
  array (
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(ReserverTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(ReserverTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new ReserverTableMap());
        }
    }
...
//
ReserverTableMap::buildTableMap();
