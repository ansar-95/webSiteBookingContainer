...
class DureeTableMap extends TableMap
{
  ...
  array (
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(DureeTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(DureeTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new DureeTableMap());
        }
    }
