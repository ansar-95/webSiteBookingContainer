...
use \Exception;
use \PDO;
use App\Http\Model\Migrations as ChildMigrations;
use App\Http\Model\MigrationsQuery as ChildMigrationsQuery;
use App\Http\Model\Map\MigrationsTableMap;
 ...
 *
 * @method     ChildMigrations|null findOne(ConnectionInterface $con = null) Return the first ChildMigrations matching the query
 ...
 *
 * @method     ChildMigrations|null findOneById(int $id) Return the first ChildMigrations filtered by the id column
 * @method     ChildMigrations|null findOneByMigration(string $migration) Return the first ChildMigrations filtered by the migration column
 * @method     ChildMigrations|null findOneByBatch(int $batch) Return the first ChildMigrations filtered by the batch column *
...
abstract class MigrationsQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \App\Http\Model\Base\MigrationsQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\App\\Http\\Model\\Migrations', $modelAlias = null)
    {
