...
abstract class Migrations implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Http\\Model\\Map\\MigrationsTableMap';
    ...
    /**
     * Initializes internal state of App\Http\Model\Base\Migrations object.
     */
     ...
     * @return $this|\App\Http\Model\Migrations The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Http\\Model\\Migrations'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Http\Model\Migrations
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Http\Model\Migrations The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Http\Model\Migrations (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Http\Model\Migrations Clone of current object.
     * @throws PropelException
     */
